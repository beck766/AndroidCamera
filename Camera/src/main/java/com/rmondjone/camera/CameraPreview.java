...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        try {
            ...
            //设置预览方向
            Log.i(TAG, "surfaceCreated: >"+getDisplayOrientation());
            ...
            Log.i(TAG, "surfaceCreated: width="+Math.max(previewSize.getWidth(), previewSize.getHeight())+"height="+ Math.min(previewSize.getWidth(), previewSize.getHeight()));
            ...
            Log.i(TAG, "surfaceCreated: width="+Math.max(pictureSize.getWidth(), pictureSize.getHeight())+"height="+ Math.min(pictureSize.getWidth(), pictureSize.getHeight()));
